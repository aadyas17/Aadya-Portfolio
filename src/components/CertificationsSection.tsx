  ...
  return (
    <section id="certifications" className="section-padding max-w-5xl mx-auto">
      ...
      >
        ...
        <h2 className="font-display text-3xl md:text-4xl font-bold mb-3 text-foreground">Certifications</h2>
        <p className="text-sm italic text-muted-foreground mb-10">Professional learning and industry certifications.</p>
