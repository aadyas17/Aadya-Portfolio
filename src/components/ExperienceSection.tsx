...
const experiences = [
  {
    role: "SAP BTP Intern",
    company: "Sharp Gurus Pvt Ltd",
    period: "Feb 2026 - June 2026",
    description: "Worked with SAP BTP Cloud Foundry Environment and SAP ABAP Development Tools. Developed and tested SAP Fiori applications. Gained hands-on experience with enterprise application development and SAP cloud technologies.",
  },
  {
    role: "AI Intern",
    company: "TechSaksham (Microsoft & SAP via Edunet)",
    period: "Dec 2024 - Jan 2025",
    description: "Built a real-time face recognition attendance system using Python and OpenCV, achieving over 90% recognition accuracy with automated logging.",
  },
  {
    role: "AI Intern",
    company: "SkillDzire (AICTE)",
    period: "Nov 2024 - Dec 2024",
    description: "Worked on ML foundations: regression, classification, and clustering using Python and Scikit-Learn.",
  },
];
